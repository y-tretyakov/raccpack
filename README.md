...
<p align="center">
  ...
  <a href="Cargo.toml"><img src="https://img.shields.io/badge/version-0.2.14-blue?style=flat-square" alt="version"/></a>
...
**Version `0.2.14`** — MVP `0.1.0` closed; **Alpha** (stash / rinse / raid) done, `A4` git+DX in progress toward `0.3.0` (git status in dig, config migrate + `init`, tracing logs with global `--verbose` done).
