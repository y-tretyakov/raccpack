# WORKLOG_DETECT — архив Detect v2 (D1–D4 → 0.4.0)

Полный журнал фазы Detect v2. **Текущий** статус ведётся в корневом [`WORKLOG.md`](../../WORKLOG.md).

Не дополнять новыми Beta-записями — только historical reference.
