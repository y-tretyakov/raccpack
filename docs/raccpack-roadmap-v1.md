...
**Текущая точка:** Alpha 0.3.0 закрыт; идёт **Detect v2** (фаза D1 ✅; фаза D2 ✅; D3.1 ✅ 0.3.7 — rinse по DAG scopes; далее D3.2).  

**Текущая версия:** `0.3.7` — сверять `docs/VERSION_ROADMAP.md`.
