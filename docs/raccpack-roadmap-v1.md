...
**Текущая точка:** Alpha 0.3.0 закрыт; **Detect v2 0.4.0 закрыт** (D1–D4 all ✅). **Beta B1.1 TUI skeleton done (0.4.1).** Далее Beta.

**Текущая версия:** `0.4.1` — сверять `docs/VERSION_ROADMAP.md`.
...
- A4.4 — Интеграционные тесты core + CI job `cargo test`. ✅ **(Alpha exit 0.3.0)**
