...
features:
  ...
  - title: CLI · TUI · Desktop
    details: Одна бизнес-логика, три интерфейса. Сейчас в CLI доступны sniff и dig, остальные команды — по roadmap.
  - title: Безопасность по умолчанию
    details: Секреты маскируются в отчётах, dry-run перед разрушающими операциями.
  - title: Den — хранилище
    details: Vault с зашифрованными секретами, архивами и JSON-манифестами каждой операции.
---
