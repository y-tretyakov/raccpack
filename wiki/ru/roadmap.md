...
::: info
Текущая версия: **0.3.4** — Alpha завершена; Detect v2 в работе (фаза D1 закрыта; начата D2: `--detect-mode composite_dag` исполняется и заполняет `stack_tree`, экспериментально).
