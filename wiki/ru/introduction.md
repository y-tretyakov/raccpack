...
- TUI — интерактивный терминальный интерфейс: Overview-дашборд, Projects (карточки/таблица/дерево), находки dig, мастер raid, Visual System 2.0, reveal modal (экран sniff с 0.4.2, dig с 0.4.3, raid с 0.4.4, visual + cards + activity с 0.4.5).
...
| **TUI** | Beta (экраны sniff + dig + raid) | Интерактивный терминальный интерфейс: таблица проектов, неблокирующий sniff/dig/raid, маскированные находки, мастер raid, навигация |
