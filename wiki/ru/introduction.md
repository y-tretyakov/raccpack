...
- TUI — интерактивный терминальный интерфейс с экранами sniff/dig/raid/pack, прогрессом, reveal modal (экран sniff с 0.4.2, экран dig с 0.4.3, экран raid с 0.4.4, reveal с 0.4.5, pack с 0.4.6).
...
| **TUI** | Beta (экраны sniff + dig + raid + pack) | Интерактивный терминальный интерфейс: таблица проектов, неблокирующий sniff/dig/raid/pack, маскированные находки, мастер raid, pack flow, навигация |
