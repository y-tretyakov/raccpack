...
- TUI skeleton — Ratatui-бинарник с навигацией, темой, экранами (с 0.4.1).
- TUI — интерактивный терминальный интерфейс с экранами sniff/dig/raid, прогрессом, reveal modal;
...
| **TUI** | Beta (skeleton 0.4.1) | Терминальный интерфейс с интерактивной навигацией |
