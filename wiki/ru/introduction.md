...
- TUI — интерактивный терминальный интерфейс с экранами sniff/dig/raid, прогрессом, reveal modal (экран sniff с 0.4.2).
...
| **TUI** | Beta (экран sniff 0.4.2) | Интерактивный терминальный интерфейс: таблица проектов, неблокирующий sniff, навигация |
