...
- TUI — интерактивный терминальный интерфейс с экранами sniff/dig/raid, прогрессом, reveal modal (экран sniff с 0.4.2, экран dig с 0.4.3, экран raid с 0.4.4, reveal с 0.4.5).
