...
- **Содержимое**: файлы больше 1 МиБ и бинарные (null-байт в первых 8 КиБ) при контентном сканировании пропускаются — подробнее [Основные понятия](/ru/concepts).
...
| [Что поддерживается](/ru/supported) | Полный список правил по имени и содержимому |
| [Основные понятия](/ru/concepts) | Риски, маскирование, skip-политика |
