...
Статус: актуально для **raccpack 0.4.4** (Detect v2 завершена: композитные DAG-детекторы, пакетный рейд `racc raid --root`; Beta B1.4 TUI sniff + dig + raid screens done).
