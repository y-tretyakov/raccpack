...
Статус: актуально для **raccpack 0.4.5** (Detect v2 завершена: композитные DAG-детекторы, пакетный рейд `racc raid --root`; Beta B1.4 TUI raid done; Visual System 2.0 TUI done).
