...
- ничего не мигрирует на диске (авто-миграция конфига v0 → v1 выполняется in-memory при загрузке, см. [Конфигурация](/ru/configuration#config-version-и-миграция)).
...
Подробно о формате файла и секциях: [Конфигурация](/ru/configuration).
...
| Страница | Роль |
|----------|------|
| [Конфигурация](/ru/configuration) | Формат `config.toml`, `config_version` и миграция |
| [Основные понятия](/ru/concepts) | Den и раскладка хранилища |
| [Быстрый старт](/ru/quick-start) | Первый прогон за пять минут |
| [Использование CLI](/ru/cli-usage) | Обзор всех команд |
