...
Status: accurate for **raccpack 0.4.6** (Detect v2 complete: DAG composite detectors, batch raid `racc raid --root`; Beta B1.4 TUI sniff + dig + raid screens done; B1.5 TUI reveal modal done; T-02 TUI pack flow done).
