...
::: info
Текущая версия: **0.2.13** (Alpha: stash / rinse / raid / init доступны).
...
## В работе (Alpha — сейчас, 0.2.x → 0.3.0)

- [ ] Финализация Alpha: tracing без секретов (`--verbose`), интеграционные тесты и CI.
