...
::: info
Current version: **0.3.4** — Alpha complete; Detect v2 in progress (phase D1 closed; D2 started: `--detect-mode composite_dag` now executes and fills `stack_tree`, experimental).
