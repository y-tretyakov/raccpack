...
> **Note** Раздел ориентирован на пользователей, автоматизирующих raccpack (CI-скрипты, инструменты). Сигнатуры приведены в упрощённом виде; точные имена и поля живут в crate `raccpack-core`.
...
- [Архитектура](architecture.md) — слои и границы доверия.
- [Дорожная карта](roadmap.md) — какой статус у каждой операции.
