...
> **Note** Неизвестные ключи в TOML не ломают загрузку — будущие секции не сломают существующие конфигурации.
...
> **Note** Без `scan_root` в конфигурации и без флага `--root` `racc` завершится с ошибкой `MissingScanRoot`.
...
- [Использование CLI](cli-usage.md) — все флаги команд.
- [Основные понятия](concepts.md) — что такое den и как устроен вывод.
